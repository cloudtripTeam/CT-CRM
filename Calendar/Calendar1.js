...
function CalendarControl() {
    ...
    function calendarDrawTable() {
        ...
        var daysInMonth;
        var i;
        var table = "<table  bgcolor='#FF6C03' cellspacing='0'  cellpadding='0' border='0'>";
        var NoCal = 2;
        try {
        ...
        if (NoCal == 3) {
            table = table + "<tr ><td  class='previous' style='border-bottom:1px solid #ffffff'><a href='javascript:changeCalendarControlMonth(-5);'>&lt;</a><a href='javascript:changeCalendarControlMonth(-5);'>&lt;</a></td>"
            table = table + "<td style='border-bottom:1px solid #ffffff; font-weight:bold; color:#ffffff;'>Select Your Travel Date  </td>";
            table = table + "<td  class='next' align='right' style='border-bottom:1px solid #ffffff'><a href='javascript:changeCalendarControlMonth(1);'>&gt;</a><a href='javascript:changeCalendarControlMonth(1);'>&gt;</a></td>";  
            table = table + "</tr>"
        } else if (NoCal == 2) {
        table = table + "<tr><td colspan='2'><table cellspacing='0'  cellpadding='0' border='0' width='100%'><tr><td  class='previous' style='border-bottom:1px solid #ffffff' align='left'>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:changeCalendarControlMonth(-3);'>&lt;</a><a href='javascript:changeCalendarControlMonth(-3);'>&lt;</a></td>";
        table = table + "<td style='border-bottom:1px solid #ffffff; font-weight:bold; color:#ffffff; text-align:center;'>Select Your Travel Date</td>";
        table = table + "<td  class='next' align='right' style='border-bottom:1px solid #ffffff'><a href='javascript:changeCalendarControlMonth(1);'>&gt;</a><a href='javascript:changeCalendarControlMonth(1);'>&gt;</a>&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr></table></td></tr>";
        } else {
        ...
        for (i = 1; i <= NoCal; i++) {
            ...
            table = table + "<td bgcolor='#ffffff'></td>" + "<td colspan='5' class='title' bgcolor='#ffffff' style='color:#FF6C03; padding:3px 0 3px 0;'>" + months[currentMonth - 1] + "&nbsp;&nbsp;&nbsp;" + currentYear + "</td>" + "<td bgcolor='#ffffff'></td>";
            table = table + "</tr>";
        ...
        table = table + "</tr>"
        table = table + "<tr class=''><th colspan='" + NoCal + "' style='padding: 3px;'><a href='javascript:hideCalendarControl();'><font color=white><b>Close</b></font></a></th></tr>"
        table = table + "</table>";
        return table
    }
...
document.write("<iframe id='CalendarControlIFrame'  frameBorder='0' scrolling='no' style='height:0px;'></iframe>");
document.write("<div id='CalendarControl' id='cal' style='height:auto; position:fixed;'></div>");
