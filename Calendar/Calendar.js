...
function CalendarControl() {
    ...
    function calendarDrawTable() {
        ...
        if (NoCal == 3) {
            ...
            // table = table + "<tr><td class='previous'>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:changeCalendarControlMonth(-1);'><img src='images/untitled.bmp'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:changeCalendarControlMonth(1);'><img src='images/untitledn.bmp'></a></td></tr>";
        }
        ...
        for (i = 1; i <= NoCal; i++) {
            ...
            table = table + "<td bgcolor='#ffffff'></td>" + "<td colspan='5' class='title' bgcolor='#ffffff' style='color:#fd5f00; font-weight:bold; padding:8px 0 3px 0;'>" + months[currentMonth - 1] + "&nbsp;&nbsp;&nbsp;" + currentYear + "</td>" + "<td bgcolor='#ffffff'></td>";
            table = table + "</tr>";
        ...
        table = table + "</tr>"
        table = table + "<tr class=''><th colspan='" + NoCal + "' style='padding: 3px 165px; '><a href='javascript:hideCalendarControl();'><font color=black><b>Close X</b></font></a></th></tr>"
        table = table + "</table>";
        return table
    }
