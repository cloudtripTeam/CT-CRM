...
/// <summary>
/// Summary description for PaymentFormHelpe
/// </summary>
...
public class PayzoneSetting
{
    ...
    public PayzoneSetting()
    {
        // Code that runs on application startup

        // get the MerchantID and Password from the config file
        m_szMerchantID = "TRAVEL-8122159";
        m_szPassword = "Ajf116emarchant";

        // get the PaymentProcessorDomain
        m_szPaymentProcessorDomain = "paymentprocessor.net";

        // get the PreSharedKey
        m_szPreSharedKey = "59G7m9Z6ZpFBW68RcqLL7S30fkC+Rp0Ozc7Ij6HKjmMMcTY9A3w=";
        // get the HashMethod
        m_hmHashMethod = PaymentFormHelper.GetHashMethod("SHA1");

        // get the ResultDeliveryMethod
        m_rdmResultDeliveryMethod = PaymentFormHelper.GetResultDeliveryMethod("POST");
    }
