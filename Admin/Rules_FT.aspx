<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="Rules_FT.aspx.cs" Inherits="Rules_FT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">Discounts Status <small style="color:greenyellow"><i> - Turn On/Off All Discounts i.e Rules with Negative value</i></small></div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Rules Details</div>
            <div class="panel-body" style="line-height: 20px;">
                <div class="row">
                    <div class="col-md-3">
                        <label>Rules From</label>

                        <asp:TextBox runat="server" ID="txtRulesFrom" MaxLength='3' CssClass="form-control" placeholder="ANY" />
                        <span>&nbsp;</span>
                    </div>
                    <div class="col-md-3">
                        <label>Rules To</label>
                        <asp:TextBox runat="server" ID="txtRulesTo" MaxLength='3' CssClass="form-control" placeholder="ANY" />
                    ...
                    <div class="col-md-3">
                        <label>Rules Class</label>

                        <asp:TextBox runat="server" CssClass="form-control" ID="txtRulesClass" placeholder="ANY" />
                ...
                <div class="row">
                  ...
                  <div class="col-md-3"  style="text-align:right" >
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-danger btn-lg" OnClientClick="return AddRules();" Text="Add" OnClick="btnAdd_Click" />
                        <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-primary btn-lg" OnClientClick="return SearchRules();" Text="Search" OnClick="btnSearch_Click" />
                    </div>
                </div>
            </div>
            <br />
              ...
              <div class="row" style="" >
                    <p style="color:greenyellow">
                       ...
                       <small><i>1. Campaign Id</i></small><br />
                        ...
                        <small><i>6. Category (Cabin Type)</i></small><br />
                        <small><i>7. Journey Type</i></small><br />
                        <small><i>Final: Maximum Discount Or Least Markup value will be implemented out of all rules satisfying above.</i></small><br />
                          <small><i>Note: Discount off Button will deactivate all the Rules with (-)Negative values</i></small>
                            </p>
    ...
    <%--Excel Downloading/Uploading Region Start--%>
            ...
            <div id="bulkUpdate" class="panel-collapse collapse">
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnUpload" runat="server" class="btn btn-success btn-xs" OnClientClick="return SearchCall();" Text="Upload Rules" OnClick="btnUpload_Click" />
                            <br />
                            Note Excell Sheet name Must be "Sheet 1"
                        </div>
                        <div class="col-md-2">
                            <asp:Button ID="btnExport1" runat="server" class="btn btn-primary btn-xs" Text="Export Rules"
                                OnClick="btnExport1_Click" />
                        </div>
                        <div class="col-md-3">
                            <asp:Button ID="btnDeleteAll" Enabled="false" class="btn btn-danger btn-xs" runat="server" OnClientClick="return confirm('Are you sure delete all Rules?')" Text="Delete All Rules"
        ...
        <%--Excel Downloading/Uploading Region End--%>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="line-height: 34px; padding: 0px!important;">
                <asp:Repeater ID="rptrDetails" runat="server">
                    ...
                    <ItemTemplate>
                        <tr id='tr<%# Eval("RulesID")%>'>
                             <td><asp:CheckBox id="chk" runat="server"/></td>
                            <td class='gdvr'><%# Container.ItemIndex+ 1 %></td>
                            <td class='gdvr'><%# Eval("RulesFrom")%></td>
                            <td class='gdvr'><%# Eval("RulesTo")%></td>
                            <td class='gdvr'><%# Eval("AirV")%></td>
                            <td class='gdvr'><%# Eval("RulesClass")%></td>
                            ...
                            <td class='gdvr'>
                                <asp:HiddenField ID="hdMkid" Value='<%# Eval("RulesID")%>' runat="server" />
                                <img src='../images/CardDelete.png' style='cursor: pointer;' onclick="DeleteRules(&#39;<%# Eval("RulesID")%>&#39;);" />
				<asp:LinkButton runat="server" ToolTip='<%#Eval("RulesID") %>'   OnClick="linkbtn_Click" ID="linkbtn" Style="color: #188fff;"><img src="../images/copy.png" width="15" /></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="gdvr exelcss">
                                <input maxlength="3" onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtRulesFrom<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;RulesFrom&#39;,&#39;<%# Eval("RulesFrom")%>&#39;);" value='<%# Eval("RulesFrom")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input maxlength="3" onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtRulesTo<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;RulesTo&#39;,&#39;<%# Eval("RulesTo")%>&#39;);" value='<%# Eval("RulesTo")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input maxlength="3" onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtAirV<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;AirV&#39;,&#39;<%# Eval("AirV")%>&#39;);" value='<%# Eval("AirV")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input maxlength="3" onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtRulesClass<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;RulesClass&#39;,&#39;<%# Eval("RulesClass")%>&#39;);" value='<%# Eval("RulesClass")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input maxlength="6" onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtJourneyType<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;JourneyType&#39;,&#39;<%# Eval("JourneyType")%>&#39;);" value='<%# Eval("JourneyType")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input onfocus="this.select();" style="width: 50px; font-size: 12px;" id='txtAmount<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;Amount&#39;,&#39;<%# Eval("Amount")%>&#39;);" value='<%# Eval("Amount")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input onfocus="this.select();" maxlength='1' style="width: 40px; font-size: 12px;" id='txtAmountType<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;AmountType&#39;,&#39;<%# Eval("AmountType")%>&#39;);" value='<%# Eval("AmountType")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input onfocus="this.select();" maxlength="10" style="width: 70px; font-size: 12px;" id='txtValidFromDate<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;ValidFromDate&#39;,&#39;<%# Eval("ValidFromDate","{0:dd/MM/yyyy}")%>&#39;);" value='<%# Eval("ValidFromDate","{0:dd/MM/yyyy}")%>' type="text"></td>
                            <td class="gdvr exelcss">
                                <input onfocus="this.select();" maxlength='10' style="width: 70px; font-size: 12px;" id='txtValidToDate<%# Eval("RulesID")%>' onblur="oblurUpdate(&#39;<%# Eval("RulesID")%>&#39;,&#39;ValidToDate&#39;,&#39;<%# Eval("ValidToDate","{0:dd/MM/yyyy}")%>&#39;);" value='<%# Eval("ValidToDate","{0:dd/MM/yyyy}")%>' type="text"></td>
                            <td class="gdvr"><%# Eval("CompanyID")%></td>
                            <td class="gdvr"><%# Eval("CampID")%></td>
                            <td class="gdvr" title='<%# Eval("ModifiedDate","{0:dd-MM-yyyy HH:mm}")%>'><%# Eval("ModifiedBy")%></td>
                        </tr>
            ...
            <div class="panel-footer">
                <asp:Button ID="btnExport" runat="server" CssClass="btn btn-primary btn-lg" OnClick="btnExport_Click" Visible="false" Text="Download" />
                <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger btn-lg" Visible="false" Text="Delete" OnClientClick="SearchRules();" OnClick="btnDelete_Click" />
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function AddRules() {
            ...
            if ($("#<%= txtAmount.ClientID %>").val() == "") {
                strMsg += "Rules amount is empty not allowed!!\n\r";
            }
        ...
        function DeleteRules(ID) {
            if (confirm("Are you sure delete this Rules??")) {
                waitingDialog.show("Please wait...");
                $.ajax({
                    type: "POST",
                    url: "Rules_FT.aspx/DeleteRules",
                    ...
                    success: function (data) {
                        ...
                        if (data.d == "true")
                        {
                            ...
                            alert("Rules is not successfully deleted from database!!");
                    },
        ...
        function oblurUpdate(ID, UpdateField, OldValue) {
            ...
            if (isUpdate) {
                ...
                switch (UpdateField) {
                    case "RulesFrom":
                        if ($("#txt" + UpdateField + ID).val().length != 3) {
                            $("#txt" + UpdateField + ID).focus();
                            alert("Rules from only three charector is allowed");
                            return;
                        }
                        break;
                    case "RulesTo":
                        if ($("#txt" + UpdateField + ID).val().length != 3) {
                            $("#txt" + UpdateField + ID).focus();
                            alert("Rules to only three charector is allowed");
                            return;
                        }
                        break;
                    case "AirV":
                ...
                $.ajax({
                    type: "POST",
                    url: "Rules_FT.aspx/UpdateRulesExcel",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    ...
                    success: function (data) {
                        if (data.d != "true") {
                            alert("Rules is not successfully Updeted in database!!");
                        }
                    },
                    error: function (data) { }
                });
        ...
        $(document).ready(function () {
            $(".checkbox").Sswitch({
                onSwitchChange: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "Rules_FT.aspx/UpdateDisCountRules",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify(Param),
                        responseType: "json",
                        success: function (data) {
                            if (data.d == "true") {
                                alert("Rules Sheet Set to " + p + "!");
                            }
                            else {
                                alert("Rules Sheet Not Updated!");
                            }
                        },
                        error: function (data) { }
                    });
