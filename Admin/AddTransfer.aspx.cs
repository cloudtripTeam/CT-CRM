...
public partial class Admin_AddTransfer : System.Web.UI.Page
{
    ...
    protected void btnSaveTransfer_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            lblmsg.Text = "Car Transfer added in existing booking successfully.";
        }
        catch (Exception)
        {

            lblmsg.Text = "Sorry to add a Car Transfer in existing booking.";
        }
