<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="BookingDetailsSchedule.aspx.cs" Inherits="Admin_BookingDetailsSchedule" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2" style="display:none">
                         ...
                         <div class="col-md-2">
                            <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-danger btn-lg" style="float:right!important" OnClientClick="return SearchBooking();"
            ...
            <asp:Repeater ID="rptrDetails" runat="server">
                        ...
                        <table class="table table-striped  table-hover table-bordered" style="font-size: 12px !important;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="gdvh">Booking&nbsp;Assigned</th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class='gdvr'><%# Eval("Supplier_Ref")%></td>
