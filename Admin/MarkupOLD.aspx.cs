...
public partial class Admin_Markup : CompressedPage
{
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        foreach (string cls in markupcalss)
        {
            ...
            {
                //string temp = cls;
                retStatus = objGetSetDatabase.SET_FlightMarkupDetail("", txtMarkupFrom.Text.Trim().ToUpper(), txtMarkupTo.Text.Trim().ToUpper(), txtAirV.Text.Trim().ToUpper(),
        ...
        {
            lblMsg.Text = "duplicate markup is already exits in database!!";
        }
        else
        {
            lblMsg.Text = "Markup is not successfully Updeted in database!!";
        }
    ...
    private void bindMarkUp()
    {
        ...
        UserDetail objUserDetail = HttpContext.Current.Session["UserDetails"] as UserDetail;
              ...
              DataTable dt = objGetSetDatabase.GET_FlightMarkupDetail("", txtMarkupFrom.Text.Trim(), txtMarkupTo.Text.Trim(), txtAirV.Text.Trim(),
        ...
        {
            lblMsg.Text = "No any markup found for given searching criteria";
        }
    ...
    protected void btnExport1_Click(object sender, EventArgs e)
    {
        ...
        if (dt != null)
        {
            ...
            string attachment = "attachment; filename=" + "Markup_" + DateTime.Now.ToString("ddMMMyyyy") + ".xls";
    ...
    protected void btnDeleteAll_Click(object sender, EventArgs e)
    {
        ...
        {
            GetSetDatabase objGetSetDatabase = new GetSetDatabase();
            if (objGetSetDatabase.SET_FlightMarkupDetail("Truncate"))
            {
