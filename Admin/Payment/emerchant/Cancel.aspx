<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Cancel.aspx.cs" Inherits="Admin_Payment_emerchant_Cancel" %>
        ...
        <div class="container">
            <div class="page-title-wrapper">
                <div class="page-title-content">
                    ...
                    <h2 class="captions">Transaction Cancelled</h2>
                </div>
            </div>
        </div>
    </section>
...
<section >
        <div class="container p-30">
            <div class="pay-now-outer">
                <h3 class="text-center">Transaction Cancelled</h3>
            <div class="pay-now-box">

                <div class="pay-now-inner"><p></p>
                    <h3>Sorry</h3>
                    <p>Your Transaction has been cancelled please contact us on </p>
