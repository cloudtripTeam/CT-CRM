<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AddTrain.aspx.cs" Inherits="Admin_AddTrain" %>
            ...
            <div class="panel panel-default p-20">
                <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <asp:Button ID="btnSaveTrain" CssClass="btn btn-primary btn-lg" runat="server" Text="Add Train" ValidationGroup="makehbooking" OnClick="btnSaveTrain_Click" />
                        </div>
