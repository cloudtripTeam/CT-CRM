<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SendtoSupplier.aspx.cs" Inherits="Admin_SendtoSupplier" %>
            ...
            <div class="panel-heading">
                <div class="pull-left">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" href="#bookingdetails">Itinerary Details to Ticket Supplier</a>
                    </h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="container">
                                ...
                                <ul class="tabs">
                                    <li class="tab-link current" data-tab="tab-1">Flight Details for Supplier</li>
