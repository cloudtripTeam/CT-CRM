...
public partial class ChargebackUploading : System.Web.UI.Page
{
    ...
    {
        DataTable dRt = (DataTable)ViewState["DATAEXEAL"];
        ...
        if (dRt != null)
        {
            ...
            string tab = "";
            foreach (DataColumn dc in dRt.Columns)
            {
