<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AddItinerary.aspx.cs" Inherits="Admin_Default2" %>
        ...
        $(document).ready(function () {
            $(".checkbox").Sswitch({
                onSwitchChange: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "AddItinerary.aspx/UpdateUseStatus",
                ...
                <div class="panel-body target" style="display: none; background: #333; line-height: 22px">
                    ...
                    <div class="row" style="">
                        <p style="color: greenyellow">
                            ...
                            <small><i>1. Departure date should be between vFrom and vTo</i></small><br />
                            ...
                            <small><i>Air, ADT Base Fare, ADT Tax Fare, Origin, Dest, Camp ID, Offer Type, vFrom, vTo, Status</i></small><br />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Crncy">
                                  ...
                                  <asp:TemplateField HeaderText="Cabin">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_cabin" runat="server" Text='<%# Eval("CabinClassCode") %>' CssClass="lbl_item_data"></asp:Label>
                                        <asp:TextBox ID="txt_cabin" Width="20px" runat="server" Text='<%# Eval("CabinClassCode") %>' Visible="false"></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        <asp:TextBox ID="txtftr_cabin" runat="server" Width="30px" />
                                    </FooterTemplate>
                                </asp:TemplateField>
