<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OwnItineraryUS.aspx.cs" Inherits="Admin_Default_US" %>
        ...
        $(document).ready(function () {
            $(".checkbox").Sswitch({
                onSwitchChange: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "OwnItineraryUS.aspx/UpdateUseStatusUS",
                        ...
                        success: function (data) {
                            debugger
                            if (data.d == "true") {
                                alert("Itinerary Set to " + chkValue + " according to filters!");
                            }
                            else {
                                alert("Itinerary Not Updated!");
                            }
                        },
                        error: function (data) { }
                    });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Itinerary Status <small style="color: greenyellow"><i>- Turn On/Off All Own Itinerary Based On Filters</i></small></div>
