    ...
    public string SalesSection(string FromDate, string ToDate)
    {
        ...
        if (currentDate.Count() == 0)
        {
            ...
            if (totalReturnDayWise > 0 && totalSpendDayWise > 0)
            {
                ...
                objGetSetDatabase.GET_SET_LastMonthData_LeadDashboard(totalSpendDayWise, totalReturnDayWise, Convert.ToString(totalSpendDayWise > 0 ? Math.Round((totalReturnDayWise / totalSpendDayWise), 2) : 0), "INSERT");
            }
        }
        else
        {
            ...
            if (totalReturnDayWise > 0 && totalSpendDayWise > 0)
            {
                ...
                //Insert for Month Data Per day basis
                objGetSetDatabase.GET_SET_LastMonthData_LeadDashboard(totalSpendDayWise, totalReturnDayWise, Convert.ToString(totalSpendDayWise > 0 ? Math.Round((totalReturnDayWise / totalSpendDayWise), 2) : 0), "UPDATE");
            }
        }
