<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ChargebackUploading.aspx.cs" Inherits="ChargebackUploading" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">       
         function validation() {
             ...
             } if (document.getElementById('drpChageTpe').value == "0") {
                 alert("Please Select Charge Type");
                 document.getElementById('drpChageTpe').focus();
                 return false;
             }
             ...
             if (document.getElementById('drpChrgBackStus').value == "0") {
                 alert("Please Select Chargeback Status：");
                 document.getElementById('drpChrgBackStus').focus();
                 return false;
             }
             if (document.getElementById('drpDocumentType').value == "0") {
                 alert("Please Select Document Type：");
                 document.getElementById('drpDocumentType').focus();
                 return false;
             }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="panel panel-default">         
            <div class="panel-heading">Chargeback uploading</div>
      <div class="container">
                 ...
                 <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                        <asp:DropDownList ID="drpChrgBackStus" ClientIDMode="Static" runat="server" CssClass="form-control" Width="102%" PlaceHolder="Chargeback Statu">
                            <asp:ListItem Selected="True" Value="0" Text="---------Select------" ></asp:ListItem>
               ...
               <HeaderTemplate>
                        <table width='100%' cellpadding='0' cellspacing='0' class="table"  style='margin-bottom: 0px;'>
                            <tr>
                                ...
                                <td class='gdvh'>Chargeback Dispute Report Date</td>                            
