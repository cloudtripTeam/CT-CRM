...
public partial class Admin_FltBooking_makeBooking2 : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem rt in rptrPax.Items)
        {
            ...
            dr["PAX_DTL_ModifiedDate"] = Convert.ToDateTime(txtBookingDate.Text);
            pdt.Rows.Add(dr);
        ...
        {
            DataRow dr = sdt.NewRow();//input.ToString().PadLeft(length, '0')
            ...
            dr["SEC_DTL_From_Date_Time"] = ((TextBox)(ris.FindControl("FromDate"))).Text + " " + fromtime;
            dr["SEC_DTL_To_Destination"] = ((TextBox)(ris.FindControl("txtTo"))).Text;
            dr["SEC_DTL_To_Date_Time"] = ((TextBox)(ris.FindControl("ToDate"))).Text + " " + toTome;
            ...
            dr["SEC_DTL_ModifiedDate"] = Convert.ToDateTime(txtBookingDate.Text);
            sdt.Rows.Add(dr);
        }
        string b;
        b = objsave.SaveOfflineBookingInDBOld(sdt, dtPrice, pdt, ddlStatus.SelectedValue, ddlCurrency.SelectedValue, ddlCompany.SelectedValue, "", objUserDetail.userID, txtRemarks.Text, lblDestination.InnerText, lblPNR.InnerText, txtPhone.Text, txtMobile.Text, txtEmail.Text, txtAddress.Text, txtCity.Text, DdlCountry.SelectedValue, Convert.ToDateTime(txtBookingDate.Text));
        if (b !="false")
        {
            lblMsg.Text = "New Booking "+ b + " Created";
        }
