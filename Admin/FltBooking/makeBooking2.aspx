<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="makeBooking2.aspx.cs" Inherits="Admin_FltBooking_makeBooking2" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                     ...
                     <div class="col-md-2">
                        ...
                        <asp:TextBox runat="server" CssClass="form-control" MaxLength='10'  onclick="showCalender(this);"  ID="txtBookingDate" placeholder="Booking Date" />
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator13" ControlToValidate="txtBookingDate" InitialValue="" ValidationGroup="makebooking" runat="server" ErrorMessage="provide booking date"></asp:RequiredFieldValidator>
                    ...
                    <asp:Repeater ID="rptrSect" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="gdvr exelcss">
                                    <asp:TextBox ID="FromTime" MaxLength="5" Width="80px" Font-Size="12px" CssClass="form-control" onkeyup="AllowDecimal(this)"  SetFocusOnError="true"  Text='<%# Eval("Departure.Time")%>' ValidationGroup="cxp"  runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss">
                                    ...
                                    <asp:TextBox ID="ToTime" MaxLength="5" Width="80px" Font-Size="12px" CssClass="form-control"  SetFocusOnError="true" onkeyup="AllowDecimal(this)"  Text='<%# Eval("Arrival.Time")%>' ValidationGroup="cxp"  runat="server"></asp:TextBox>
