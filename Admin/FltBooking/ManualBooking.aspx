<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ManualBooking.aspx.cs" Inherits="Admin_FltBooking_ManualBooking" %>
            ...
            <div class="panel-body" style="line-height: 34px;">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <asp:TextBox runat="server" ID="txtPnr" MaxLength='20' CssClass="form-control" />
                    ...
                    <div class="col-md-2">
                        <label>&nbsp;</label><br />
                        <asp:Button ID="btnSearch" ValidationGroup="makebooking" runat="server" CssClass="btn btn-success btn-sm" Text="Proceed" OnClick="btnSearch_Click" />
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="line-height: 34px;">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label>Cabin </label>
                            <asp:DropDownList ID="ddlCabinClassMaster" runat="server" CssClass="form-control">
                                ...
                                <asp:ListItem Text="Premium Economy" Value="Premium" />
                            </asp:DropDownList>
                        </div>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="gdvr exelcss">
                                    <input maxlength="8" class="form-control" style="font-size: 12px;" id='txtPaxType' runat="server" value='<%# Eval("PassengerType")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss">
                                    <input maxlength="5" class="form-control" style="font-size: 12px;" id='txtTitle' runat="server" value='<%# Eval("Title")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss">
                                    <input maxlength="30" class="form-control" style="font-size: 12px;" id='txtFirstName' runat="server" value='<%# Eval("FirstName")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss">
                                    <input maxlength="20" class="form-control" style="font-size: 12px;" id='txtMiddleName' runat="server" value='<%# Eval("MiddleName")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss">
                                    <input maxlength="30" class="form-control" style="font-size: 12px;" id='txtLastName' runat="server" value='<%# Eval("LastName")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss">
                                    <input maxlength="10" class="form-control" style="font-size: 12px;" id='txtDOB' runat="server" autocomplete="off" value='<%# Eval("DOB")%>' type="text" />
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator10" ControlToValidate="txtMobile" ValidationGroup="cxp" ErrorMessage="Please enter Mobile!"  style="color:red!important"/>
                            </div>
                            <div class="col-md-4">
                                <label>Phone</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator11" ControlToValidate="txtEmail" ValidationGroup="cxp" ErrorMessage="Please enter Email ID!" style="color:red!important"/>
                            </div>
                            <div class="col-md-4">
                                <label>Address</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator12" ControlToValidate="txtCity" ValidationGroup="cxp" ErrorMessage="Please enter City!" style="color:red!important" />
                            </div>
                            <div class="col-md-4">
                                <label>Country</label>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="line-height: 34px; padding: 0px!important;">
                    <asp:Repeater ID="rptrSect" runat="server">
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="gdvr" style="width: 2px!important"><%# Container.ItemIndex+ 1 %></td>
                                <td class="gdvr exelcss" style="width: 25px!important">
                                    <asp:TextBox ID="txtFrom" MaxLength="3" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("Departure.AirportCode")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss" style="width: 25px!important">
                                    <asp:TextBox ID="txtTo" MaxLength="3" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("Arrival.AirportCode")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss" style="width: 40px!important">
                                    <asp:TextBox ID="txtAirV" MaxLength="2" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("AirV")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss" style="width: 90px!important">
                                    <asp:TextBox ID="txtFLTNO" MaxLength="6" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("FltNum")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss" style="width: 30px!important">
                                    <asp:TextBox ID="txtClass" MaxLength="1" Font-Size="12px" CssClass="form-control" Text='<%# Eval("Class")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                ...
                                <td class="gdvr exelcss" style="width: 84px!important">
                                    <asp:TextBox ID="FromDate" onclick="showCalender(this);" MinLength="8" MaxLength="10" Font-Size="12px" AutoCompleteType="Disabled" CssClass="form-control" SetFocusOnError="true" autofill="false" ValidationGroup="cxp" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator6" SetFocusOnError="true" ControlToValidate="FromDate" ValidationGroup="cxp" ErrorMessage="Enter a valid departure Date!" />
                                </td>
                                <td class="gdvr exelcss" style="width: 30px!important">
                                    <asp:TextBox ID="FromTime" MaxLength="4" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("Departure.Time")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator7" ControlToValidate="FromTime" ValidationGroup="cxp" ErrorMessage="Enter valid departure Time!" />
                                </td>
                                <td class="gdvr exelcss" style="width: 84px!important">
                                    <asp:TextBox ID="ToDate" onclick="showCalender(this);" MinLength="8" MaxLength="10" Font-Size="12px" AutoCompleteType="Disabled"  CssClass="form-control" SetFocusOnError="true" autofill="false" ValidationGroup="cxp" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator8" ControlToValidate="ToDate" ValidationGroup="cxp" ErrorMessage="Enter a valid  arrival date!" />
                                </td>
                                <td class="gdvr exelcss" style="width: 30px!important">
                                    <asp:TextBox ID="ToTime" style="" MaxLength="4" Font-Size="12px" CssClass="form-control" SetFocusOnError="true" Text='<%# Eval("Arrival.Time")%>' ValidationGroup="cxp" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator9" ControlToValidate="ToTime" ValidationGroup="cxp" ErrorMessage="Enter valid Arrival Time!" />
                                </td>
                                <td class="gdvr exelcss" style="width: 66px!important">
                                    <input maxlength="6" class="form-control" style="font-size: 12px;" id='txtStatus' runat="server" value='<%# Eval("Status")%>' type="text" />
                                </td>
                                <td class="gdvr exelcss" style="width: 115px!important">
                                ...
                                <td class="gdvr exelcss" style="width: 120px!important">
                                    <input class="form-control" style="font-size: 12px;" id='txtBaggageAllownce' runat="server" value='<%# Eval("BaggageInfo")%>' type="text" />
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
                ...
                <div class="panel-body" id="pnlManulaSector" runat="server" visible="false">
                        ...
                        <ContentTemplate>
                            ...
                            <table width='100%' cellpadding='0' cellspacing='0' class='table' style='background-color: #ddd; margin-bottom: 0px;'>
                                ...
                                <tr>
                                    ...
                                    <td class='gdvh'>
                                        <input maxlength="10" class="form-control" style="font-size: 12px;" onkeyup="AllowDecimal(this)" id='txtSalePriceF' runat="server" type="text" /></td>
                                    <td class='gdvh'>
                                        <input maxlength="10" class="form-control" style="font-size: 12px;" onkeyup="AllowDecimal(this)" id='txtCostPriceF' runat="server" type="text" /></td>

                                    <td class='gdvh'>
                                        <asp:Button ID="btnAdd" CssClass="btn btn-sm btn-success" runat="server" OnClientClick="return validate();" Text="Add" OnClick="btnAdd_Click" />
                                    </td>
            ...
            <div class="panel panel-default p-20">
                <div class="col-md-12">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnSave" CssClass="btn btn-success btn-sm" runat="server" ValidationGroup="cxp" Text="Make Booking" OnClick="btnSave_Click" />
                    </div>
