<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="OwnFares_US.aspx.cs" Inherits="Admin_OwnFaresUS" %>
         ...
         $(document).ready(function () {
             $(".checkbox").Sswitch({
                 onSwitchChange: function () {
                     ...
                     $.ajax({
                         type: "POST",
                         url: "OwnFares_US.aspx/UpdateDiscountOwnFare_US",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">All Own Fares Status<small style="color:greenyellow"><i> - Disable / Enable all own fares of TJUS and C2BUS</i></small></div>
                                      ...
                                      <td class='gdvr'>
                                        ...
                                        <td class='gdvr'>
                                         ...
                                         <td class='gdvr'>
                                           ...
                                           <td class='gdvr'>
                                            <input style="width: 30px; font-size: 12px;" id='txtTrip<%# Eval("SrNo")%>' onfocus="this.select();" onblur="oblurUpdate(&#39;<%# Eval("SrNo")%>&#39;,&#39;DTD&#39;,&#39;<%# Eval("Trip")%>&#39;);" value='<%# Eval("Trip")%>' type="text">
                                        </td>
                                          <td class='gdvr'>
    ...
    <script type="text/javascript">
        ...
        function CheckValidation() {
            ...
            //else if (/^[a-zA-Z]{1}(,[a-zA-Z]{1})*$/.test($("#ContentPlaceHolder1_txtAirlineClass").val())) {
        ...
        function DeleteFare(ID) {
            if (confirm("Are you sure delete this Own Fare?")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "OwnFares_US.aspx/DeleteFaresUS",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        function oblurUpdate(ID, UpdateField, OldValue) {
            ...
            if (isUpdate) {
                ...
                if (CheckValidFlightType(($("#txtFlightType" + ID).val()))) {
                    $.ajax({
                        type: "POST",
                        url: "OwnFares_US.aspx/UpdateFare_US",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: JSON.stringify(Param),
                        responseType: "json",
