<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SearchBooking.aspx.cs" Inherits="Admin_SearchBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function SearchBooking() {
            ...
            if (document.getElementById('<%=txtBookingID.ClientID %>').value.trim() == "" && document.getElementById('<%=txtPNRConfirmation.ClientID %>').value.trim() == ""
               && document.getElementById('<%=txtEmailAddress.ClientID %>').value.trim() == "" && document.getElementById('<%=txtMobileNo.ClientID %>').value.trim() == ""
                && document.getElementById('<%=txtPaxFirstName.ClientID %>').value.trim() == "" && document.getElementById('<%=txtPaxLastName.ClientID %>').value.trim() == ""
                && document.getElementById('<%=txtPhoneNo.ClientID %>').value.trim() == "" 
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var strHtml = "<table width='100%' class='table' cellspacing='0' border='0' cellpadding='0'>" +
                                ...
                                "<td colspan='3'><a href='BookingEditDetails.aspx?BID=" + jsdata.BM.BookingID + "&PID=" + jsdata.BD.ProdID + "'>Edit Booking Details</a></td></tr></table>";
