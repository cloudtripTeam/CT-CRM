<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true"
    CodeFile="MarkupJazzUS.aspx.cs" Inherits="Admin_MarkupJazzUS" %>
        ...
        $(document).ready(function () {
            $(".checkbox").Sswitch({
                onSwitchChange: function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "MarkupJazzUS.aspx/UpdateDiscountMarkupJazz_US",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">Discounts Status<small style="color: greenyellow"><i> - Turn On/Off All Discounts i.e Rules with Negative values</i></small></div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-md-offset-3">
                                <asp:Button ID="btnExport" runat="server" Text="Export Markup" CssClass="btn btn-primary btn-sm"
    ...
    <script type="text/javascript">
        ...
        function DeleteMarkup(ID) {
            if (confirm("Are you sure delete this markup??")) {
                ...
                $.ajax({
                    type: "POST",
                    url: "MarkupJazzUS.aspx/DeleteMarkupJazzUs",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
        ...
        function oblurUpdate(ID, UpdateField, OldValue) {
            ...
            if (isUpdate) {
                ...
                $.ajax({
                    type: "POST",
                    url: "MarkupJazzUS.aspx/UpdateMarkupExcel_JazzUS",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify(Param),
                    responseType: "json",
