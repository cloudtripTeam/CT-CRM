<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Markup.aspx.cs" Inherits="Admin_MarkupUk" %>
                 ...
                 $(document).ready(function () {
                     $(".checkbox2").Sswitch({
                         onSwitchChange: function () {
                             ...
                             $.ajax({
                                 type: "POST",
                                 url: "Markup.aspx/UpdateDiscountMarkup_CA",
                                 contentType: "application/json; charset=utf-8",
                                 dataType: "json",
                                 data: JSON.stringify(Param),
                                 responseType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container-fluid" >
        <div id="ONOFF" runat="server">
        <div class="col-md-6">
             <div class="panel panel-default">
            <div class="panel-heading">Discounts Status<small style="color: greenyellow"><i> - Turn On/Off All Discounts i.e Rules with Negative values for US</i></small></div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
            <div class="panel-heading">Discounts Status<small style="color: greenyellow"><i> - Turn On/Off All Discounts i.e Rules with Negative values for Canada</i></small></div>
            <div class="panel-body" style="line-height: 34px;">
                <input type="checkbox" name="checkboxisActive2" class="checkbox2" runat="server" id="checkboxisActive2" clientidmode="Static" />
            </div>
        </div>
            ...
            <div class="panel-body" style="line-height: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <asp:TextBox runat="server" CssClass="form-control" ID="txtDTD" MaxLength="3" data-minLength="1" Text="0" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label>Stops</label>
                        <asp:TextBox runat="server" CssClass="form-control" AutoComplete="off" ID="txtStops" Text="-1" />
                    </div>
                     <div class="col-md-2">
                        <label>Days Between Departures</label>
                        <asp:TextBox runat="server" CssClass="form-control" AutoComplete="off" ID="txtDBD" Text="999" />
                    </div>
                     <div class="col-md-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="text-align: right; margin-top: 25px!important">
                ...
                <div class="panel-body target" style="display: none; background: #333;">
                    ...
                    <div class="row" style="">
                        <p style="color: greenyellow">
                            ...
                            <small><i>Days between departure is the minimum date difference</i></small><br />
                            <br />
                ...
                <asp:Repeater ID="rptrDetails" runat="server">
                    <HeaderTemplate>
                        <table width='100%' cellpadding='0' cellspacing='0' class='table' style='margin-bottom: 0px; font-size: 13px'>
                            <tr>
                                ...
                                <td class='gdvh'>Stops</td>
                                <td class='gdvh'>IsGroup</td>
                                 <td class='gdvh'>DBD</td>
                    ...
                    <ItemTemplate>
                        <tr id='tr<%# Eval("MarkupID")%>'>
                            ...
                            <td class='gdvr'><%# Eval("Stops")%></td>
                            <td class='gdvr'><%# Eval("IsGroupCode")%></td>
                             <td class='gdvr'><%# Eval("DaysBetweenDeparture")%></td>
                ...
                <asp:Repeater ID="rptrEdit" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td class="gdvr" title='<%# Eval("ModifiedDate","{0:dd-MM-yyyy HH:mm}")%>'><%# Eval("ModifiedBy")%></td>
                            <td class="gdvr">
                                <input onfocus="this.select();" style="width: 30px; font-size: 12px;" id='txtStops<%# Eval("MarkupID")%>' onblur="oblurUpdate(&#39;<%# Eval("MarkupID")%>&#39;,&#39;Stops&#39;,&#39;<%# Eval("Stops")%>&#39;);" value='<%# Eval("Stops")%>' type="text">
                            </td>
                            <td class="gdvr">
                                <input onfocus="this.select();" style="width: 40px; font-size: 12px;" id='txtIsGroup<%# Eval("MarkupID")%>' onblur="oblurUpdate(&#39;<%# Eval("MarkupID")%>&#39;,&#39;IsGroupCode&#39;,&#39;<%# Eval("IsGroupCode")%>&#39;);" value='<%# Eval("IsGroupCode")%>' type="text">
                            </td>
                              <td class="gdvr">
                                <input onfocus="this.select();" style="width: 30px; font-size: 12px;" id='txtDaysBetweenDeparture<%# Eval("MarkupID")%>' onblur="oblurUpdate(&#39;<%# Eval("MarkupID")%>&#39;,&#39;DaysBetweenDeparture&#39;,&#39;<%# Eval("DaysBetweenDeparture")%>&#39;);" value='<%# Eval("DaysBetweenDeparture")%>' type="text">
                            </td>
                ...
                switch (UpdateField) {
                    case "MarkupFrom":
                        if ($("#txt" + UpdateField + ID).val().length != 3) {
                            $("#txt" + UpdateField + ID).focus();
                            alert("Markup from only three character is allowed");
                            return;
                        }
                        break;
                    case "MarkupTo":
                        if ($("#txt" + UpdateField + ID).val().length != 3) {
                            $("#txt" + UpdateField + ID).focus();
                            alert("Markup to only three character is allowed");
                            return;
                        }
                        break;
                    case "AirV":
                        if ($("#txt" + UpdateField + ID).val() != "ANY") {
                            if ($("#txt" + UpdateField + ID).val().length != 2) {
                                $("#txt" + UpdateField + ID).focus();
                                alert("Airline only two character or 'ANY' is allowed");
                                return;
                            }
                        }
                        break;
