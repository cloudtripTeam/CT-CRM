...
public partial class OnlineMarkup_Markup_Import_Export2 : System.Web.UI.Page
{
    //HttpApplication app;
    //bool isFile = false;
    ...
    {
        string filepath =Server.MapPath(@"~\Admin\Markup\") + "Markup_"+DateTime.Now.ToString("ddMMMyyyy") + ".xlsx";
        ExcelLibrary.DataSetHelper.CreateWorkbook(filepath, table);

        lblMsg.Text = "Markup file generated, <a href='//www.flightsandholidays.biz/admin/Markup/Markup_" + DateTime.Now.ToString("ddMMMyyyy") + ".xlsx' >click here to download</a>";
