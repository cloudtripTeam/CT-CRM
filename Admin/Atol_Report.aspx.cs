...
public partial class Admin_Atol_Report : System.Web.UI.Page
{
    ...
    protected void btnFind_Click(object sender, EventArgs e)
    {
        ...
        if (objUserDetail != null)
        {
            string role = objUserDetail.userRole.ToLower();
                ...
                dtAtol = db.GET_Atol_Report("","", txtFromDate.Text == "" ? null : txtFromDate.Text, txtToDate.Text == "" ? null : Convert.ToDateTime(txtToDate.Text).AddDays(1).ToString("dd/MM/yyyy"),
