...
function drawChartByStatus(jsdata) {
    ...
    // Set chart options
    var options = {
        'title': 'Enquiry Report By Status',
...
function drawChartByCompany(jsdata1) {
    ...
    // Set chart options
    var options = {
        'title': 'Enquiry Report By Company',
        'width': 400,
        'height': 300,
        'is3D': true
    };
...
function drawChartBySource(jsdata) {
    ...
    // Set chart options
    var options = {
        'title': 'Enquiry Report By Source',
        'width': 400,
        'height': 300,
        'is3D': true
    };
...
function GetCallsReportByCompany() {
    ...
    $.ajax({
        type: "POST",
        url: "EnquiryReports.aspx/getCallsByCompany",
...
function GetCallsReportBySource() {
    $.ajax({
        type: "POST",
        url: "EnquiryReports.aspx/getCallsBySource",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
