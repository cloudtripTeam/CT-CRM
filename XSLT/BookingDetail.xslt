    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="900px">
        ...
        <td style="font-family: Arial, Helvetica, sans-serif;">
          <table border="0" cellpadding="0" cellspacing="0" width="900px">
            <tr>
              ...
              <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                <xsl:value-of select="FlightDetail/Itinerary/PNRInfo/PNRNo"/>
              </td>
            </tr>
            <tr>
              <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
      ...
      <tr>
        <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;">
          <br />
          <fieldset>
            <legend style="font-size: 13px;font-family: Arial, Helvetica, sans-serif;  color: #000000; font-weight: bold;">Passenger(s)</legend>
            <table width="800px">
      ...
      <tr>
        <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;">
          <br />
          <fieldset>
            <legend style="font-size: 13px; color: #000000; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">
              Flight Details
            </legend>
      ...
      <tr>
        <td style="padding: 5px 10px 5px 10px;" align="left">
          <br />
          <fieldset>
            <legend style="font-size: 13px; color: #000000; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">Price Details</legend>
      ...
      <xsl:if test="Insurance/@Status!='NULL'">
        <tr>
          <td style="padding: 5px 10px 5px 10px;">
            <br />
            <fieldset>
              <legend style="font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #000000; font-weight: bold;">Insurance Detail</legend>
              <xsl:if test="Insurance/@Status='YES'">
                <table cellpadding="2" cellspacing="2" width="100%">
                  <tr>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                        width="190px">
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/Id"/>
                    </td>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                        width="190px">
                      Policy ID
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/PolicyId"/>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/PolicyName"/>
                    </td>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                        width="190px">
                      Policy Cover Type
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/CoverType"/>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/Area"/>
                    </td>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                        width="190px">
                      Duration
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/Duration"/>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                    ...
                    <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;" width="250px">
                      <xsl:value-of select="Insurance/Amount"/>
                    </td>
                    <td style="font-size: 13px; color: #000000; font-weight: bold; padding: 5px 10px 5px 10px;"
                        width="190px">
                    </td>
                  ...
                  <tr>
                    <td colspan="6">
                      Note:- Your Policy documents will be emailed to you directly from Holidayrisk
                    </td>
                  </tr>
                </table>
              </xsl:if>
              <xsl:if test="Insurance/@Status='NO'">
                <table cellpadding="2" cellspacing="2" width="800">
                  <tr>
                    <td style="font-size: 13px; color: #ff0000; font-weight: bold; padding: 5px 10px 5px 10px;">
                      NOTE:- Sorry there has been a problem in comfirming your Insurance Policy, One of our consultant will be in touch shortly alternatively you can call us on 0000000000000
                    </td>
                  </tr>
                </table>
              </xsl:if>
      ...
      <tr>
        <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;">
          <br />
          <fieldset>
            <legend style="font-size: 13px; color: #000000; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">Your Financial Protection</legend>
            <table cellpadding="2" cellspacing="2" width="100%">
              <tr>
      ...
      <tr>
        <td style="font-size: 12px; color: #000000; padding: 5px 10px 5px 10px;">
          <br />
          <fieldset>
            <legend style="font-size: 13px; color: #000000; font-family: Arial, Helvetica, sans-serif; font-weight: bold;">Payment Type:</legend>
            <table cellpadding="2" cellspacing="2" width="100%" style="font-size: 12px; color: #000000; font-family: Arial, Helvetica, sans-serif; ">
              <tr >
                <td>
                  Card Holder Name:
                </td>
              ...
              <tr>
                ...
                <td style="color: #FF0404; font-family: Verdana; font-size: 10pt; font-weight: bold">
                  <xsl:choose>
                    <xsl:when test="Insurance/@Status='YES'">
                      <xsl:if test="Payment/AtolStatus='true'">
                        £<xsl:value-of select="format-number(FlightDetail/Itinerary/GrandTotal+Payment/CardCharge+Insurance/Amount+((PaxDetail/NoOfAdult+PaxDetail/NoOfChild+PaxDetail/NoOfInfant)*4),'#.00')"/>
                      </xsl:if>
                      <xsl:if test="Payment/AtolStatus='false'">
                        £<xsl:value-of select="format-number(FlightDetail/Itinerary/GrandTotal+Payment/CardCharge+Insurance/Amount,'#.00')"/>
                      </xsl:if>
                    </xsl:when>
                    <xsl:otherwise>
                      <xsl:if test="Payment/AtolStatus='true'">
