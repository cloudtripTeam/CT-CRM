	...
	"use strict";
		...
		$.extend(Plugin.prototype, {
		    ...
		    init: function () {
				...
				_qs.$increment = _qs.$el.find('.quantity-selector-incrementAdt a');
				_qs.$decrement = _qs.$el.find('.quantity-selector-decrementAdt a');
				_qs.$current = _qs.$el.find('.quantity-selector-currentAdt');
		    ...
		    inputValue: function (v) {
		        if (v === 0)
		            ...
		            _qs.$input.val(totPax + ' ' + _qs.setTitle);
